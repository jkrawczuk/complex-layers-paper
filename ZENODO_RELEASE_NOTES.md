...
Planned release tag: `v1.0.0-peerj-submission`

## Main Archive

The GitHub release archive should contain the tracked repository files:
...
Upload the generated paper-run result bundles as a separate Zenodo file:

- `complex-layers-paper-runs-v1.0.0.zip`

This artifact should contain `results/paper_runs/`, including raw predictions, selected features, per-split
...
## After Zenodo DOI Assignment

Replace DOI placeholders in:
