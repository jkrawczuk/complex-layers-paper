...
$p \gg n$ conditions \cite{guyon2002,dudoit2002,li2004}. In comparative studies, this benchmark
...
formulation used for the custom sparse neuron: the hinge-loss objective with L1 regularization is convex and
piecewise linear, which allows the neuron to be trained through linear programming. In contrast,
