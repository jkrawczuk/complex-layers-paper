...
The real-data benchmark showed that later neurons can be useful when the first neuron contains few features.
Under low-feature settings on \texttt{colon\_cancer}, all three learners exhibited at least one configuration in
...
captured by the initial low-feature solution alone.
In contrast, high-feature first-neuron solutions often concentrated most of the predictive signal immediately,
